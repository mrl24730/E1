...
<html>
  <head>
	...
	<script src="<%=domain_cn %>/js/jquery/jquery-1.9.1.min.js" type="text/javascript"></script>
    <script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
    
  </head>
  <body style="background:yellow;">
	<div id="div-preview" onClick="hide();" style="position:absolute; top:0; left:0; width:100%; height:100%; display:none; background:url(<%=domain_cn %>/images/POS/background.png); z-index:99;">
		<img style="margin:20px auto; display:block;" id="pic" />
		<a href="javascript:hide();" style="background:url(<%=domain_cn %>/images/fancybox/fancybox.png) repeat -40px 0; position:absolute; top:10px; display:none; width:30px; height:30px; display;none;"></a>
	</div>
  	<div id="content">
    	...
    	--><div id="info">
				...
				<div id="hk_images" style="display:none;">
					<a style="margin-right:23px;" href="javascript:largeImg('images/POS/HongKong_Shop_1.jpg');" ><img src="<%=domain_cn %>/images/POS/HongKong_Shop_1_s.jpg" /></a>
					<a href="javascript:largeImg('images/POS/HongKong_Shop_2.jpg');" ><img src="<%=domain_cn %>/images/POS/HongKong_Shop_2_s.jpg" /></a>
				</div>
				<div id="gz_images" style="display:none; position:absolute; bottom:56px;">
					<a style="margin-right:23px;" href="javascript:largeImg('images/POS/GuangZhou_Shop_1.jpg');" ><img src="<%=domain_cn %>/images/POS/GuangZhou_Shop_1_s.jpg" /></a>
					<a href="javascript:largeImg('images/POS/GuangZhou_Shop_2.jpg');" ><img src="<%=domain_cn %>/images/POS/GuangZhou_Shop_2_s.jpg" /></a>
				</div>
    	   </div>
	</div>
  <!-- Google Map Script -->
  <script>
	  ...
	  */
        if (status == google.maps.GeocoderStatus.OK) {
          ...
          var markerSize = new google.maps.Size(70,60);
        	...
        	var  markerImg = new google.maps.MarkerImage("<%=domain_cn %>/images/eb_pin.png",markerSize, o_point, a_point2,displaySize);
	...
	{
		$("#pic")[0].src = "<?php echo $cnDomain ?>/"+path;
		$("#div-preview").fadeIn();
