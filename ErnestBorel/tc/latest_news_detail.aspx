...
<div id="doc">
	...
	<div id="docWrapper">
		...
		<div id="outer" class="main-content">
			<section>
				<h2>企業新聞</h2>
                <span id="breadcrumbNav"><a href='/tc/' >依波路</a> &gt; <a href='newspage' >企業新聞 </a> &gt; 正文</span>
				...
				<div class="yui3-g">
					<div class="yui3-u-3-4">
						<div class="content newsblock_dt">
							...
							<span id="articleInfo">
								來源：<a rel='author'>瑞士依波路官網 </a><br />
								作者：<cite>瑞士依波路 </cite> <br />
								文章發佈時間：<time><%=obj.displayDate %></time>
							</span>
